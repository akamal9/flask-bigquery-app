...
from sentence_app.utils.bq_table_manager import check_dataset_exists, check_table_exists_and_schema

FLASK_APP_PATH = ".sentence_app/main.py"
...
if __name__ == "__main__":
    ...
    try:
        ...
        response_times = load_sentences(LOCAL_FILE)
